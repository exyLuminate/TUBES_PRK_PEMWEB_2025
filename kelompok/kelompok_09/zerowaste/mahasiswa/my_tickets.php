                            ...
                            <div class="flex flex-col md:flex-row justify-between md:items-start gap-4">
                                ...
                                <div class="flex-grow">
                                    ...
                                    <div class="text-sm text-gray-600 space-y-1">
                                        <p><span class="font-semibold w-24 inline-block">Kode Tiket:</span> <span class="font-mono font-bold text-blue-600 bg-blue-50 px-2 rounded"><?= $t['kode_tiket'] ?></span></p>
                                        <p><span class="font-semibold w-24 inline-block">Lokasi:</span> <?= htmlspecialchars($t['lokasi_pickup']) ?></p>
